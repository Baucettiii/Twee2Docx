...
def export_to_docx(passages, output_filename, debug_mode=False):
    ...
    try: doc.save(output_filename); print(f"Successo! File '{output_filename}' creato correttamente.")
    except Exception as e: print(f"Errore durante il salvataggio del file DOCX: {e}")
